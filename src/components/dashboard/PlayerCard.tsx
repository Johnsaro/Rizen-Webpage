        ...
        <div className="dash-card player-card fade-in-up" style={{ animationDelay: `${delay}s` }}>
            <div className="player-header">
                <div className="player-avatar-container">
                    ...
                    <div className="level-badge premium-level">LV {user.level}</div>
                </div>
                ...
                <div className="player-rep">
                    <div className="rep-label">REP</div>
            ...
            <div className="player-stats">
                ...
                <div className="stat-group primary-stat-group" style={{ marginBottom: '1.5rem' }}>
                    <div className="stat-header">
                        <span className="stat-label" style={{ color: 'var(--text-primary)', fontWeight: 600 }}>XP TO NEXT LEVEL</span>
                ...
                <div className="streak-badge">
                    ...
                    <span className="streak-text">{user.stats.streak}-DAY STREAK</span>
                </div>
            </div>
        </div>
    );
